...
Bahmni.Clinical.DrugOrderViewModel.createFromContract = function (drugOrderResponse, config) {
    ...
    var administrationInstructions = drugOrderResponse.dosingInstructions.administrationInstructions || "{}";
    administrationInstructions = angular.isObject(drugOrderResponse.dosingInstructions.administrationInstructions) ? administrationInstructions : JSON.parse(administrationInstructions);
